...
Кнопка **«Создать сверку»** добавлена в интерфейс. Запрос создания сверки будет подключен после описания модели запроса.
